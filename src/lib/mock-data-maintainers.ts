...
export const mockMaintainers: MockMaintainers = {
    ...
    oficinasRegionales: [
        ...
        { id: 'or-3', value: 'Antofagasta' },
        { id: 'or-4', value: 'Atacama' },
        { id: 'or-5', value: 'Coquimbo' },
        { id: 'or-6', value: 'Valparaíso' },
        { id: 'or-7', value: 'Metropolitana de Santiago' },
        { id: 'or-8', value: 'Libertador General Bernardo O\'Higgins' },
        { id: 'or-9', value: 'Maule' },
        { id: 'or-10', value: 'Ñuble' },
        { id: 'or-11', value: 'Biobío' },
        { id: 'or-12', value: 'La Araucanía' },
        { id: 'or-13', value: 'Los Ríos' },
        { id: 'or-14', value: 'Los Lagos' },
        { id: 'or-15', value: 'Aysén del General Carlos Ibáñez del Campo' },
        { id: 'or-16', value: 'Magallanes y de la Antártica Chilena' },
    ],
    genero: [
