...
import { z } from 'zod';
import { REQUEST_TYPES, REGIONES_CHILE, VIAS_DE_INGRESO } from '@/lib/constants';
...
export async function submitSolicitudInterna(
  prevState: any,
  formData: FormData
  ...
  const validatedFields = SolicitudSchema.safeParse({
    ...
    viaIngreso: formData.get('viaIngreso'),
  ...
  console.log('Solicitud Interna Recibida:', validatedFields.data);
